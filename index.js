...
client.on('guildMemberAdd', member => {
    ...
    .setColor('GREEN')
    .setFooter('Finex-Bot', 'https://media.discordapp.net/attachments/451742829325189120/477469827154575361/6.png?width=300&height=300')
